...
framesPerTrig = 1;
depthVid.FramesPerTrigger=framesPerTrig; % FramesPerTrigger specifies the number of frames the video input object acquires each time it executes a trigger using the selected video source
